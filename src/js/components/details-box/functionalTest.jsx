...
const FunctionalTestBox = ({ functionalTest } : Props) => {
  ...
  const passedPercent = parseInt((functionalTest.passed * 100) / (functionalTest.passed + functionalTest.failed))
        ...
        <div className='details-box__row'>
          <div className='details-box__column'>
            <dl className='functional-test__coverage-result'>
              <div className='progress__offset' style={{width: `${functionalTest.coveragePercent}%`}} />
